...
<head id="Head1" runat="server">
    ...
    <title>Logical HR forget password</title>
                ...
                <div class="content-wrapper">
                    <div class="panel panel-body login-form" style="margin-top: 70px;">
                        <div class="text-center">
                            <img src="Template/assets/images/infologiaglobe.png" class="img-circle img-lg" alt="" />
                            <h5 class="content-group">Forgot Password? <small class="display-block">Enter your e-mail address below to reset your password.</small></h5>
                        </div>
                        <div class="form-group has-feedback has-feedback-left">
                            <asp:TextBox ID="txt_email" runat="server" CssClass="form-control" required="" placeholder="Enter your registered email"></asp:TextBox>
                        ...
                        <div class=" text-center">
                            ...
                            <div id="Div_fail" runat="server" class="alert alert-danger" visible="false">
                                <button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Close</span></button>
                                <asp:Label ID="Lbl_Fail" runat="server"></asp:Label>
                            </div>
                            <div id="div_suscc" runat="server" class="alert alert-success" visible="false">
                                <button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Close</span></button>
                                <asp:Label ID="Lbl_Sucs" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
