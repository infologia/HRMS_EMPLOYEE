<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="payroll.aspx.cs" Inherits="Admin_payroll" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Employee Payroll Details</h5>
            <div class="heading-elements">
                <ul class="icons-list">
<%--              <a href="Monthlysalary.aspx" class="btn btn-primary  pull-right"><i class="icon-eye"></i> View</a>--%>
                </ul>
            </div>
        </div>
        ...
        <table class="table datatable-basic">
            ...
            <tbody>
                <asp:PlaceHolder ID="PH_payroll" runat="server"></asp:PlaceHolder>
            </tbody>
        </table>
    </div>
</asp:Content>
