<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="UninformedLeaves.aspx.cs" Inherits="Admin_UninformedLeaves" %>
    ...
    <div class="form-horizontal">
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <fieldset>
                        <legend class="text-semibold"><i class="icon-pencil5"></i> Leave Update</legend>
                        <div action="#">
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="text-right">
                                <a href="LeaveResponse.aspx" class="btn btn-primary" style="margin-right: 15px">Back</a>
