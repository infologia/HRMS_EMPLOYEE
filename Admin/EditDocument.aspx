<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="EditDocument.aspx.cs" Inherits="WEB_EditDocument" %>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <div action="#">
                        <fieldset>
                            <legend class="text-semibold"><i class="icon-reading position-left"></i>Update Document</legend>


                            <div class="form-group">
                                <div>
                                    <label>User Id </label>
                                    <asp:DropDownList ID="ddl_id" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_id_SelectedIndexChanged" class="form-control" required="">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
                                <div>
                                    ...
                                    <asp:TextBox ID="txt_user" runat="server" class="form-control" required="">
                                    </asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <div>
                                    ...
                                    <asp:TextBox ID="txt_letter" runat="server" class="form-control" required="">
                                    </asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="text-right">
                                    ...
                                    <a id="A1" href="Documents.aspx" runat="server" class="btn btn-primary" style="margin-right:15px">Back</a>
                                    <asp:Button ID="btn_edit" runat="server" Text="Update" class="btn btn-primary" OnClick="btn_edit_Click" style="margin-right:15px"></asp:Button>
