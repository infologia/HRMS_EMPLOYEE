<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="TaskCategoryView.aspx.cs" Inherits="Admin_TaskCategoryView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        function fn_DeleteProject(TaskCategorykey) {


            if (confirm("Are you sure,you want to delete this?")) {
                $.ajax({
                    type: "POST",
                    url: "taskcategoryview.aspx/DeleteProject",
                    data: "{ str_taskCategorykey: '" + TaskCategorykey + "'}",
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Task Category Details</h5>
            <div class="heading-elements">
                <ul class="icons-list">
                  <a href="TaskCategory.aspx" class="btn btn-primary pull-right"><i class="icon-user-plus"></i> Add New</a>
                </ul>
            </div>
        </div>
        ...
        <table class="table datatable-basic ">
            ...
            <tbody>
                <asp:PlaceHolder ID="PH_TaskCategoryView" runat="server"></asp:PlaceHolder>
