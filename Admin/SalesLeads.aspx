<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="SalesLeads.aspx.cs" Inherits="Admin_SalesLeads" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function fn_DeleteProject(leadKey) {
            ...
            $.ajax({
                type: "POST",
                url: "SalesLeads.aspx/DeleteProject",
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <a href="~/Employee/Myleadsdetails.aspx" id="a_createlead" runat="server" visible="false" class="btn btn-primary  pull-right"><i class="icon-plus-circle2"></i> Create Lead</a>
                </div>
            </div>
        </div>
