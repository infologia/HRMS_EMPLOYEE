...
public partial class WEB_Admin_ComplaintResponse : System.Web.UI.Page
{
    DataAccess DA;
    SessionCustom SC;
    PhTemplate PH;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //filter
        //string str_query = "SELECT b.Employeeid,b.username,  b.Firstname+' '+b.lastname as name,a.complaintcategory,a.Complaintresponse,a.reason,a.employeekey,a.Complaintid,a.Complaintstatus,a.Complaintkey FROM IT_Complaint a left outer join IT_EmployeeRegister b ON a.createdby = b.Employeekey where roles='1' order by a.createdon ASC";
    }
    ...
    {
        string str_query = "SELECT b.Employeeid,b.username,  b.Firstname+' '+b.lastname as name,a.complaintcategory,a.Complaintresponse,a.reason,a.employeekey,a.Complaintid,a.Complaintstatus,a.Complaintkey FROM IT_Complaint a left outer join IT_EmployeeRegister b ON a.createdby = b.Employeekey where roles='1' and 1 = 1";
        ...
        if (dt_dashboard.Rows.Count > 0)
        {
            ...
            foreach (DataRow dr1 in ds.Tables[0].Rows)
            {
                ...
                if (activetype == 1)
                    ...
                    dr1["ActiveCategory"] = "<span class='label label-info'>Student Welfare</span>";


            }
            this.PH.LoadGridItem(ds, PH_complaint, "Complaint.txt", "");
        }
    }
}
