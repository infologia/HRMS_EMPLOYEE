<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="EditProjectCategory.aspx.cs" Inherits="EditProjectCategory" %>
                    ...
                    <div id="txt_active" runat="server" visible="false"></div>
                     ...
                     <div class="form-group">
                        <div class="text-center">
                             <a href="ProjectCategoryView.aspx" class="btn btn-primary"> Back</a>
