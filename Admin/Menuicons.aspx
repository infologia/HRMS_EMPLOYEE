<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="Menuicons.aspx.cs" Inherits="Admin_Menuicons" %>
...
<h5 class="panel-title"> icon set</h5></div><div class="col-md-6  pull-right">
<a  href="ParentMenu.aspx"  class="btn btn-primary pull-right"><i class="icon-undo"></i> Back</a>
</div>
</div>
