<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="Taskview.aspx.cs" Inherits="Admin_Taskview" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  ...
  <%--  <script type="text/javascript" src="../Template/assets/js/plugins/forms/styling/switchery.min.js"></script>
	...
	<script type="text/javascript" src="../Template/assets/js/pages/tasks_grid.js"></script>--%>
