<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="Suggestionview.aspx.cs" Inherits="WEB_Admin_Suggestionview" %>
...
<div class="col-md-8">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <div action="#">
                    <fieldset>
                        <legend class="text-semibold"><i class="icon-reading position-left"></i>Suggestion Response</legend>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="text-right">
                                <a href="Suggestionresponse.aspx" class="btn btn-primary" style="margin-right: 15px">Back</a>
