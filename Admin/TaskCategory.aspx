<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="TaskCategory.aspx.cs" Inherits="Admin_TaskCategory" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>Category Name:</label>
                              ...
                              <asp:textbox ID="txt_category" runat="server" required="" class="form-control">
                                </asp:textbox>
                    </div>
                    <div class="form-group">
