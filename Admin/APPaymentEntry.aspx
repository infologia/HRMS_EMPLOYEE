<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="APPaymentEntry.aspx.cs" Inherits="Admin_APPaymentEntry" %>
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <legend class="text-semibold">
                <i class="icon-briefcase position-left"></i><span id="headcreate" runat="server">Create AP Payment</span>
            </legend>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <asp:RequiredFieldValidator runat="server"
                        ControlToValidate="ddlVendorName"
                        InitialValue=""
                        ErrorMessage="Please select a Vendor Name"
            ...
            <asp:HiddenField ID="hfAPId"        runat="server" ClientIDMode="Static" />
            ...
            <div class="row">
                <div class="col-lg-12 text-right">
                    <a href="APPaymentGrid.aspx" class="btn btn-primary">Back</a>
