...
public partial class Admin_ProjectCategory : System.Web.UI.Page
{
    ...
    protected void btn_send_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt_check = DA.GetDataTable("select * from TT_PjtCategory where categoryname='" + txt_category.Text + "'");
        ...
        try
        {
            string str_project = "insert into TT_PjtCategory(Categoryname,Description,status,createdby)values(@Categoryname,@Description,@status,@createdby)";
