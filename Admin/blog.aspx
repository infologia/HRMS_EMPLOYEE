<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="blog.aspx.cs" Inherits="Admin_blog"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-flat blog-form-section">
        <div class="panel-heading">
            <a href="blogs.aspx" class="btn-back-list">
    ...
    <script>
        (function () {
            ...
            function applyFontSize(sizeValue) {
                ...
                if (!range) {
                    // No usable range at all - fall back to end of editor.
                    range = document.createRange();
                    range.selectNodeContents(editor);
                    range.collapse(false);
                }
