<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="ParentMenus.aspx.cs" Inherits="Admin_ParentMenus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fn_DeleteMenu(menukey) {
        ...
        function confirmDeleteMenu() {
            ...
            $.ajax({
                type: "POST",
                url: "ParentMenus.aspx/DeleteMenu",
                ...
                success: function(data) {
                    ...
                    if (data.d === "1") {
                        showToastr('success', 'Parent menu deleted successfully');
                        setTimeout(function() { location.reload(); }, 1500);
                    } else {
                        showToastr('error', 'Unable to delete menu. Please try again.');
                    }
                },
                error: function() {
                    $('#confirmDeleteModal').modal('hide');
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <% if (CanCreate()) { %>
                    <a href="CreateParentMenu.aspx" class="btn btn-primary pull-right">
        ...
        <table class="table datatable-basic">
            ...
            <tbody>
                <asp:PlaceHolder ID="PH_ParentMenus" runat="server"></asp:PlaceHolder>
            </tbody>
        </table>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="mb-0">Are you sure you want to delete this parent menu?</p>
                </div>
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                    <button type="button" class="btn btn-danger" onclick="confirmDeleteMenu()">Yes, Delete</button>
                </div>
            </div>
        </div>
    </div>
