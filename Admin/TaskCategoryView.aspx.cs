...
public partial class Admin_TaskCategoryView : System.Web.UI.Page
{
    ...
    [WebMethod] //Delete
    public static string DeleteProject(string str_taskCategorykey)
    {
        ...
        try
        {
            ...
            string str_Sql = "delete from TT_TaskCategory where TaskCategorykey=@TaskCategorykey";
            SqlCommand cmd = new SqlCommand(str_Sql);
            cmd.Parameters.AddWithValue("@TaskCategorykey", str_taskCategorykey);
    ...
    private void Task()
    {
     string str_task = "select TaskCategoryKey,categoryname,description,CONVERT(Varchar,createdon,103)as createdon,status from TT_TaskCategory";
        SqlCommand cmd = new SqlCommand(str_task);
        ...
        if (dt_project.Rows.Count > 0)
        {
            ...
            this.PH.LoadGridItem(ds, PH_TaskCategoryView, "TaskCategoryView.txt", "");
        }
    }
