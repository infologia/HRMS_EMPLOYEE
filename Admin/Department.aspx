    ...
    <div class="col-xs-2 col-sm-2 col-md-2"></div>
        ...
        function SaveConfigItems() {
            ...
            $("#DyanmicCreation input[type='text']").each(function () {
                if ($(this).val().trim() === "") {
                    $(this).focus();
                    showToastr('error', 'Department field cannot be empty!');
                    isValid = false;
            ...
            $.ajax({
                ...
                type: "POST",
                url: "Department.aspx/SaveConfigItems",
            ...
            function OnSuccessCall(response) {
                if (response.d === "true") {
                    ...
                    showToastr('success', 'Department saved successfully!');

                    setTimeout(function () {
                        window.location.href = '/Admin/Department.aspx';
                    }, 2000);
...
<asp:HiddenField ID="hdn_DepIds" runat="server" />
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Employee Department</h5>
