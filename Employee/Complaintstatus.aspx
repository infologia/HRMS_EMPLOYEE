<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="Complaintstatus.aspx.cs" Inherits="WEB_Employee_Complaintstatus" %>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <div action="#">
                        <fieldset>
                            <legend class="text-semibold"><i class="icon-pencil4"></i>&nbsp;Create  Complaint</legend>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="txt_reason1" runat="server" rows="4" cols="4" class="form-control" required=""></textarea>
                        </div>
                        <div id="comp" runat="server" visible="false">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="ddl_status" InitialValue="0" runat="server" ErrorMessage="Please select Status" ForeColor="Red"></asp:RequiredFieldValidator>
                        ...
                        <div class="text-right">
                            <a id="btn_request" runat="server" href="complaintresponseview.aspx" class="btn btn-primary me-2">Back</a>
                            <asp:Button ID="btn_update" runat="server" Text="update" OnClick="btn_update_Click" class="btn btn-primary"></asp:Button>
                        </div>
                    </div>
                </div>
            </div>
