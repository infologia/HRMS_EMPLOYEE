<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="Taskcreation.aspx.cs" Inherits="Employee_Taskcreation" %>
...
<div class="row">
                                ...
                                <div class="col-md-9 col-md-offset-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txt_cldate" runat="server" class="form-control daterange-single" placeholder="MM/DD/YYYY"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group" id="div_status" runat="server" visible="false">
                                        <label>Status</label>
                                        <asp:DropDownList ID="ddl_status" runat="server" CssClass="form-control" required=""></asp:DropDownList>
                                    </div>                                    
                                    <div class="form-group">
                                        <label>Work time:</label>
                                        <asp:TextBox ID="txt_time" runat="server" class="form-control " required=""></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <div class="text-center">
                                             <a id="a_btn" runat="server" class="btn btn-primary" style="margin-right: 15px">Back</a>
    ...
    <asp:HiddenField ID="hd_attach" runat="server" />
</asp:Content>
