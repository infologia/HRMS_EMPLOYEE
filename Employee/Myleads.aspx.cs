...
public partial class Employee_Myleads : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    string str_query = "SELECT a.LeadKey, a.Name, a.Company, a.Position, c.LeadType, b.SalesStatus, a.CreatedOn, a.ModifiedOn, d.Firstname FROM IT_Leads a LEFT JOIN IT_SalesStatus b ON a.Status = b.SalesStatusKey LEFT JOIN IT_LeadType c ON a.LeadType = c.LeadTypeKey LEFT JOIN IT_EmployeeRegister d ON a.CreatedBy = d.Employeekey WHERE a.createdby='" + SC.Userid + "'";
        ...
        //        this.PH.LoadGridItem(ds, PH_leave, "Myleads.txt", "");
        //    }
        //    else
        //        return;
    ...
    public void Leads()
    {
        PH_leave.Controls.Clear();
        string str_query;
        SqlCommand cmd_division = new SqlCommand("SELECT Employeekey FROM IT_EmployeeRegister WHERE Division IN (17, 18) AND Employeekey = @Employeekey");
        cmd_division.Parameters.AddWithValue("@Employeekey", SC.Userid);
        DataTable dt_salespersonsonly = DA.GetDataTable(cmd_division);
        ...
        if (dt_salespersonsonly.Rows.Count > 0 || userRoleId == "11")
        {
            a_createlead.Visible = true;
            string str_userid = this.SC.Userid;
            ...
            str_query = "SELECT a.LeadKey, a.Name, a.Company, a.Position, c.LeadType, b.SalesStatus,FORMAT(a.CreatedOn, 'dd-MM-yyyy') AS CreatedOn,FORMAT(a.ModifiedOn, 'dd-MM-yyyy') AS ModifiedOn, d.Firstname FROM IT_Leads a LEFT JOIN IT_SalesStatus b ON a.Status = b.SalesStatusKey LEFT JOIN IT_LeadType c ON a.LeadType = c.LeadTypeKey LEFT JOIN IT_EmployeeRegister d ON a.CreatedBy = d.Employeekey WHERE a.CreatedBy=@createdby and 1 = 1";
            ...
            if (dt_dashboard.Rows.Count > 0)
            {
                ...
                ds.Tables[0].Columns.Add("ViewText");
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        dr["ViewText"] =
                            "<td><a href='Myleadsdetails.aspx?id=" + LeadKeys + "&Viewid=1'>" +
