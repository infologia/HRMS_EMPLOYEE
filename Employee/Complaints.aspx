<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminMaster.master" AutoEventWireup="true" CodeFile="Complaints.aspx.cs" Inherits="WEB_Employee_Complaints" %>
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="content-group text-semibold">Complaints Category</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="text-right">
                            <a href="complaintresponseview.aspx" class="btn btn-primary me-2" > Back</a>
